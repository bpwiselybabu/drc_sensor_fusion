...
template <class T>
static void shiftImDisp(Mat& srcim, Mat& srcdisp, Mat& destim, Mat& destdisp, double amp,double sub_gap,const int large_jump = 3 ,const Mat& mask=Mat(), int method = WARP_CUBIC)
{
	Mat mask_=mask;
