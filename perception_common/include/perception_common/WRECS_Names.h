...
namespace WRECS_NAMES
{
	...
	static const std::string ATLAS_SENSOR_FOREARM_TOPIC = "/atlas/sensors/forearm_status";
	static const std::string ATLAS_MULTISENSE_TOPIC = "atlas/multisense/status";
	static const std::string ATLAS_FALL_TOPIC = "/xxx_fall_state/fall_flag";
	//Control
	...
	static const std::string GUI_SENSOR_FOREARM_TOPIC = "/ocu/atlas/sensors/forearm_status";
	...
	static const std::string GUI_FREEZE_SWITCH_TOPIC = "ocu/freeze_switch_command";
	static const std::string GUI_HAND_NUDGE_TOPIC = "/atlas/hand_nudge_command";
	static const std::string GUI_ATLAS_MULTISENSE_TOPIC = "ocu/multisense/status";
	...
	static const std::string OCU_GUI_COMM_STARTTIME_TOPIC = "/ocu/comm_start_time";
    ...
    static const std::string PERCEPTION_SUPER_COMPRESSION = "/ask_for_compressed_image";
    static const std::string OCU_PERCEPTION_SUPER_COMPRESSION = "/ocu/ask_for_compressed_image";
